  ...
  return (
    <div className="flex flex-col items-center h-full">
      <div className="px-14 my-6 flex-col items-center">
        ...
        <p>
          Have any questions, comments, concerns, death threats and/or confessions of undying love?
          Feel free to reach out to me using my socials or the form below.
        </p>
      </div>
      ...
      <div>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-start my-2">
            ...
            <textarea
              className="border border-solid border-secondary rounded text-primary-dark p-2 sm:w-60 md:w-80 h-40"
